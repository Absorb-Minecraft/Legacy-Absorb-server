...
@OnWiki(state = PacketState.PLAY, urlTitle = "Set_Container_Slot")
public class OutgoingUpdateSlotPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingUpdateSlotPacket.ID);
    }
}
