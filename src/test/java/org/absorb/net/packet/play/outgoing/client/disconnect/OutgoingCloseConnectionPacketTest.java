...
@OnWiki(state = PacketState.PLAY, urlTitle = "Disconnect_.28play.29")
public class OutgoingCloseConnectionPacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingCloseConnectionPacket.PLAY_ID);
    }
}
