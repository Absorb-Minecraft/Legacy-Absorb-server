...
@OnWiki(state = PacketState.PLAY, urlTitle = "Chat_Message")
public class IncomingMessagePacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingMessagePacket.ID);
    }
}
