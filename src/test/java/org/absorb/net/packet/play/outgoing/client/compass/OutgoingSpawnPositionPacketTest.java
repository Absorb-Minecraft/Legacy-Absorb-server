...
@OnWiki(urlTitle = "Set_Default_Spawn_Position", state = PacketState.PLAY)
public class OutgoingSpawnPositionPacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingSpawnPositionPacket.ID);
    }
}
