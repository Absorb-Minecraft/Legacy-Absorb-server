...
@OnWiki(state = PacketState.PLAY, urlTitle = "Place_Recipe")
public class IncomingRecipePacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingRecipeRequestPacket.ID);
    }
}
