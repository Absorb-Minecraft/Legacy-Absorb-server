...
@OnWiki(state = PacketState.PLAY, urlTitle = "Client_Information")
public class IncomingClientSettingsPacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingClientSettingsPacket.ID);
    }
}
