...
@OnWiki(urlTitle = "Player_Chat_Message", state = PacketState.PLAY)
public class OutgoingChatMessagePacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingChatMessagePacket.ID);
    }
}
