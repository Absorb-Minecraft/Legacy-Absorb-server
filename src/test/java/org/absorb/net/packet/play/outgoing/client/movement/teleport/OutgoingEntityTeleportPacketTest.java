...
@OnWiki(state = PacketState.PLAY, urlTitle = "Teleport_Entity")
public class OutgoingEntityTeleportPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingEntityTeleportPacket.ID);
    }
}
