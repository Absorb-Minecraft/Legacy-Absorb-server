package org.absorb.net.packet.play.incoming.client.movement.full;
...
@OnWiki(state = PacketState.PLAY, urlTitle = "Set_Player_Position_and_Rotation")
public class IncomingFullMovementPacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingPlayerMovementPacket.ID);
    }
}
