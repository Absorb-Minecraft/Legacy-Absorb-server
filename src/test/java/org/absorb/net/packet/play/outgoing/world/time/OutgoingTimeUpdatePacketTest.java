...
@OnWiki(urlTitle = "Update_Time", state = PacketState.PLAY)
public class OutgoingTimeUpdatePacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingTimeUpdatePacket.ID);
    }
}
