...
@OnWiki(state = PacketState.PLAY, urlTitle = "Chunk_Data_and_Update_Light")
public class OutgoingChunkUpdatePacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingChunkUpdatePacket.ID);
    }
}
