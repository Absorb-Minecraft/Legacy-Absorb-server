...
@OnWiki(state = PacketState.PLAY, urlTitle = "Chat_Command")
public class IncomingCommandPacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingCommandPacket.ID);
    }
}
