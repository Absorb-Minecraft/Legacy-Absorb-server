package org.absorb.net.packet.play.outgoing.client.movement.full;
...
@OnWiki(state = PacketState.PLAY, urlTitle = "Synchronize_Player_Position")
public class OutgoingPlayerMovementPacketTest {
