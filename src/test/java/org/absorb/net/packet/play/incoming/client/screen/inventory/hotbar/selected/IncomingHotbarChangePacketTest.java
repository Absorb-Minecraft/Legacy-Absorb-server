...
@OnWiki(state = PacketState.PLAY, urlTitle = "Pick_Item")
public class IncomingHotbarChangePacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingHotbarChangePacket.ID);
    }
}
