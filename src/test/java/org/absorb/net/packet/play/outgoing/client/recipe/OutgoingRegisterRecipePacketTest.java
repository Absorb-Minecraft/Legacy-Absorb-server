...
@OnWiki(state = PacketState.PLAY, urlTitle = "Update_Recipes")
public class OutgoingRegisterRecipePacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingRegisterRecipePacket.ID);
    }
}
