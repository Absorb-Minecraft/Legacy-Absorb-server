package org.absorb.net.packet.play.outgoing.client.channel.system;

import org.absorb.net.packet.OnWiki;
import org.absorb.net.packet.PacketState;
import org.absorb.net.packet.WikiUtils;
import org.absorb.net.packet.play.outgoing.client.channel.chat.system.OutgoingSystemChatMessagePacket;
...
@OnWiki(state = PacketState.PLAY, urlTitle = "System_Chat_Message")
public class OutgoingSystemChatMessagePacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingSystemChatMessagePacket.ID);
    }
}
