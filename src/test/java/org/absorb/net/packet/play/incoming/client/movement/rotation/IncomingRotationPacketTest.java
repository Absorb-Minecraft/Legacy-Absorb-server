...
@OnWiki(state = PacketState.PLAY, urlTitle = "Set_Player_Rotation")
public class IncomingRotationPacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingRotationPacket.ID);
    }
}
