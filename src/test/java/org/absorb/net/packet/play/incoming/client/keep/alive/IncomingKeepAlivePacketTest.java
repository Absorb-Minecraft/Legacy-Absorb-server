...
@OnWiki(state = PacketState.PLAY, urlTitle = "Keep_Alive_.28serverbound.29")
public class IncomingKeepAlivePacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingKeepAlivePacket.ID);
    }
}
