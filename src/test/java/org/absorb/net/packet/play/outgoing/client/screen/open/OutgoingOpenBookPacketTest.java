...
@OnWiki(state = PacketState.PLAY, urlTitle = "Open_Book")
public class OutgoingOpenBookPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingOpenBookPacket.ID);
    }
}
