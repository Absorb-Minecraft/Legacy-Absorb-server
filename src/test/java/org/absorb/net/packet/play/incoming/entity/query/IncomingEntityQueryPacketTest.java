package org.absorb.net.packet.play.incoming.entity.query;
...
@OnWiki(urlTitle = "Query_Entity_Tag", state = PacketState.PLAY)
public class IncomingEntityQueryPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingEntityQueryPacket.ID);
    }
}
