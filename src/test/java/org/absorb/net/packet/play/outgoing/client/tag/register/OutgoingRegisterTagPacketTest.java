...
@OnWiki(state = PacketState.PLAY, urlTitle = "Update_Tags")
public class OutgoingRegisterTagPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingRegisterTagPacket.ID);
    }
}
