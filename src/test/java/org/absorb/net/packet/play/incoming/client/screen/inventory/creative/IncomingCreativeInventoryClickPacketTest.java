...
@OnWiki(urlTitle = "Set_Creative_Mode_Slot", state = PacketState.PLAY)
public class IncomingCreativeInventoryClickPacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingCreativeInventoryClickPacket.ID);
    }
}
