...
@OnWiki(state = PacketState.PLAY, urlTitle = "Client_Command")
public class IncomingClientCommandActionPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingClientCommandActionPacket.ID);
    }
}
