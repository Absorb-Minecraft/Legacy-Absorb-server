...
@OnWiki(state = PacketState.PLAY, urlTitle = "Commands")
public class OutgoingDeclareCommandsPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingDeclareCommandPacket.ID);
    }
}
