package org.absorb.net.packet.play.incoming.client.movement.teleport;
...
@OnWiki(state = PacketState.PLAY, urlTitle = "Confirm_Teleportation")
public class IncomingTeleportConfirmPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingTeleportConfirmPacket.ID);
    }
}
