...
@OnWiki(urlTitle = "Edit_Book", state = PacketState.PLAY)
public class IncomingEditBookPacketTest {
    /**
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingEditBookPacket.ID);
    }
}
