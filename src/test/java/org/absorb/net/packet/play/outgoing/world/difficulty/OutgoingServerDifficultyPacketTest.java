...
@OnWiki(state = PacketState.PLAY, urlTitle = "Change_Difficulty")
public class OutgoingServerDifficultyPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingServerDifficultyPacket.ID);
    }
}
