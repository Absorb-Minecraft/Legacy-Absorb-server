...
@OnWiki(state = PacketState.PLAY, urlTitle = "Block_Update")
public class OutgoingBlockChangePacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingBlockChangePacket.ID);
    }
}
