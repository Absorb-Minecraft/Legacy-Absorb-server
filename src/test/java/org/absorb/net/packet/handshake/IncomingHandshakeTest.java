...
@OnWiki(state = PacketState.HANDSHAKE, urlTitle = "Handshake")
public class IncomingHandshakeTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), IncomingHandshakePacket.ID);
    }
}
