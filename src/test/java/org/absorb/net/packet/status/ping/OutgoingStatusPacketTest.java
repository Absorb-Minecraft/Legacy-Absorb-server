...
import org.absorb.net.packet.status.response.StatusResponsePacket;
...
@OnWiki(state = PacketState.STATUS, urlTitle = "Status_Response")
public class OutgoingStatusPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), StatusResponsePacket.ID);
    }
}
