...
import org.absorb.net.packet.status.pong.OutgoingPongPacket;
...
@OnWiki(state = PacketState.STATUS, urlTitle = "Ping_Response")
public class OutgoingPongPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingPongPacket.ID);
    }
}
