...
import org.absorb.net.packet.login.success.OutgoingLoginSuccessfulPacket;
...
@OnWiki(state = PacketState.LOGIN, urlTitle = "Login_Success")
public class OutgoingLoginSuccessPacketTest {
    ...
    public void testPacketId() {
        ...
        Assertions.assertEquals(wikiEntry.getId(), OutgoingLoginSuccessfulPacket.ID);
    }
}
